...
# Upstream's last block guarded bin/omarchy-upgrade-to-quattro, the Omarchy 3 ->
# 4 upgrade path for existing x86_64 installs. This fork does not ship it, so no
# upgrade path can re-add the group.
